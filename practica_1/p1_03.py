...
# Newton, cuando sea posible usarlo. Para las funciones en las cuales no se pueda usar, 
# justificar.

import math as m

def newton(a, b, epsilon, f):
...
raiz = newton(0, 2, 0.001, funcion_A)
...
raiz = newton(-3, 2, 0.001, funcion_B)
...
raiz = newton(-3, 2, 0.001, funcion_C)
...
raiz = newton(-1, 2, 0.001, funcion_D)
...
raiz = newton(-1, 2, 0.001, funcion_E)
...
raiz = newton(-6, 0, 0.001, funcion_F)
...
raiz = newton(-3, -1, 0.001, funcion_G)
